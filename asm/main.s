...
blink: // r0 on led values | r1 off led values | r2 port address | r3 time to stay on
  push {r14, r0} // Temporary store values in r14 and r0
  ...
  pop {r0, r14} // Load temporary values back into the registers
  bx r14 // Jump to address stored in link register

wait: // r0 value to wait
  push {r5} // Temporary store values in r5
  ...
  pop {r5} // Load temporary values back into the registers
  bx r14 // Jump to address stored in link register